"""wundergroundpws obdervation sensors descriptions."""
...
from .const import FEATURE_CONDITIONS, FEATURE_OBSERVATIONS
...
def degrees_to_cardinal(d):
    """Map decimal degrees to cardinal direction."""
    dirs = [
        "N",
        "NNE",
        "NE",
...
obs_sensor_descriptions = [
    ...
    WundergroundPWSSensorEntityDescription(
        ...
        unit_fn=lambda metric: UnitOfVolumetricFlux.MILLIMETERS_PER_HOUR
        if metric
    ...
    WundergroundPWSSensorEntityDescription(
        ...
        unit_fn=lambda metric: UnitOfLength.MILLIMETERS
        if metric
